...
You can use the Codename: [BlueMix web user interface](https://ace.ng.bluemix.net/) or the [`cf` command line interface](http://www.ng.bluemix.net/docs/BuildingWeb.jsp#install-cf) to create an instance of the Memcached Cloud service. The following `cf` command creates the service instance:
